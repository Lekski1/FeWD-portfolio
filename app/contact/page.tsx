    ...
    return (
        <div id={styles.content}>
            ...
            <div id={styles.my_contact}>
                <p id={styles.please_write}>
                    please write to me only at the time I specified, so our dialogue will be built
                    much better 😊
                </p>
                <a
                    href="https://t.me/eldarlek"
                    target="_blank"
                ...
                <a
                    href="mailto:e.mametov@innopolis.university"
                    target="_blank"
                    className={styles.technical_profiles_link}
                    rel="noreferrer"
                >
                ...
                <a
                    href="https://www.instagram.com/55_eldar"
                    target="_blank"
                    className={styles.technical_profiles_link}
                    rel="noreferrer"
                >
